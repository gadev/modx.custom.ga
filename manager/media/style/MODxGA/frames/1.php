...
<head>
    ...
    <style>
        ...
        #mainMenu { height: 75px; width: 100%; box-shadow: 0px 0px 8px #030303; z-index:1000;}
        #tree { width: 250px; top: 75px; left: 0; bottom: 0; }
        #main { top: 75px; left: 250px; right: 0; bottom: 0; }
        #resizer { position: absolute; top: 75px; bottom: 0; left: 250px; width: 3px; cursor: col-resize; z-index: 999;border-left:1px solid #a4b9cc!important;}
        ...
        #resizer2 { position: absolute; top: 75px; right: 15px; width: 3px; z-index: 999;}
