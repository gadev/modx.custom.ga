...
email:"info@divandesign.ru",$dialog:!1},objectToJSON:function(a){if(JSON&&b.isFunction(JSON.stringify))return JSON.stringify(a);var c=[],d=b.isPlainObject(a),e="",f="";d?(e="{",f="}"):b.isArray(a)&&(e="[",f="]");for(var k in a){var h=a[k];b.isPlainObject(h)||b.isArray(h)?h=b.ddTools.objectToJSON(h):"number"!=b.type(h)&&(h='"'+h+'"');d?c.push('"'+k+'":'+h):b.isArray(a)&&c.push(h)}return e+c.join(",")+f},numberFormat:function(a){return a.toString().replace(/(\d)(?=(\d{3})+\D|(\d{3})+$)/g,"$1 ")},parseInt:function(a){a=
...
var c,d,e;"object"==typeof arguments[0]?(c=arguments[0],d=c.length):(c=arguments,d=c.length-1);for(var f=d,k=0;k<=d;k++)e="object"==typeof arguments[0]?b(c[k]).attr("src"):c[k],b(new Image).load(function(){1>--f&&"function"==typeof a&&a()}).attr("src",e)},parseChunkAssoc:function(a,c,d){var e=function(a,c){var d={};c||(c="");for(var l in a)b.isPlainObject(a[l])?b.extend(d,e(a[l],c+l+".")):d[c+l]=a[l];return d};c=e(c);for(var f in c)a=a.replace(RegExp("\\[\\+"+f+"\\+\\]","gm"),c[f]);d&&(a=a.replace(/\[\+\S+\+\]/gm,
""));return a},getDate:function(a){a=b.extend({date:"",format:"d.m.y",shortFormat:"",curDate:"",lang:"ru2",lowerCase:!0},a||{});var c=function(a){""==a?a=new Date:(a=new Date(a),b.isNumeric(a.getTime())||(a=new Date));return a},d=function(a,b){return(a+="").length<b?Array(++b-a.length).join("0")+a:a},e,f,k,h;"en"==a.lang?(e="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),f={1:"st",2:"nd",3:"rd",21:"st",22:"nd",23:"rd",31:"st"},k=" January February March April May June July August September October November December".split(" "),
...
31:"\u043e\u0435"},h=["\u0421\u0435\u0433\u043e\u0434\u043d\u044f","\u0412\u0447\u0435\u0440\u0430","\u041f\u043e\u0437\u0430\u0432\u0447\u0435\u0440\u0430"],k="ru"==a.lang?" \u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" "):
...
"/1/1"))/864E5>>0},W:function(){var b=g.z(),c=364+g.L()-b,d=((new Date(a.date.getFullYear()+"/1/1")).getDay()||7)-1;return 2>=c&&(a.date.getDay()||7)-1<=2-c?1:2>=b&&4<=d&&b>=6-d?(b=new Date(a.date.getFullYear()-1+"/12/31"),date("W",Math.round(b.getTime()/1E3))):1+(3>=d?(b+d)/7:(b-(7-d))/7)>>0},F:function(){return k[g.n()]},m:function(){return d(g.n(),2)},M:function(){t=g.F();return t.substr(0,3)},n:function(){return a.date.getMonth()+1},t:function(){var b;return 2==(b=a.date.getMonth()+1)?28+g.L():
...
a=arguments[e]:b.isNumeric(arguments[e])?c=arguments[e]:b.isFunction(arguments[e])&&(d=arguments[e]);b.isNumeric(c)||(c=300);var f=!1,k=!1,h=b.isFunction(d);b.each(a,function(b,c){"hide"==c?(f=!0,a[b]=0):"show"==c&&(k=!0,a[b]="")});return b(this).each(function(){var e=b(this);k&&e.show();setTimeout(function(){e.css(a)},10);(f||h)&&setTimeout(function(){f&&e.hide();h&&d()},c)})};b(function(){b.ddTools.$html=b("html");b.ddTools.$window=b(window);b.ddTools.$body=b("body");b.ddTools.$window.on("resize",
...
b.extend(a.ddError,{title:b.ddTools.ddErrorData.title,message:b.ddTools.ddErrorData.message});a.ddError.target||(a.ddError.target="unknown_"+window.location.toString());a.ddError.message+='<br /><small>\u0410 \u0435\u0441\u043b\u0438 \u0432\u0430\u043c \u043d\u0435 \u0442\u0440\u0443\u0434\u043d\u043e, \u043e\u0442\u043f\u0440\u0430\u0432\u044c\u0442\u0435 \u043d\u0430 <a href="mailto:'+b.ddTools.ddErrorData.email+'">'+b.ddTools.ddErrorData.email+'</a> \u0430\u0434\u0440\u0435\u0441 \u0441\u0430\u0439\u0442\u0430 \u0438 \u043a\u043e\u0434 \u043e\u0448\u0438\u0431\u043a\u0438: "'+
